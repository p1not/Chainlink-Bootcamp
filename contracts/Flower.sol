...
//Exemplo de criação de um NFT dinâmico
//https://testnets.opensea.io/assets/goerli/0x22d43348deb6d8b7d41adcb479b0d081eda45ca6/0 -  Este contrato na Goerli

import "@chainlink/contracts/src/v0.8/KeeperCompatible.sol";    //chainlink automation interface
import "@openzeppelin/contracts@4.6.0/token/ERC721/extensions/ERC721URIStorage.sol";    //onde os NFT serao salvos
import "@openzeppelin/contracts@4.6.0/utils/Counters.sol";  //para q o id do NFT aumente sozinho
...
contract Flower is ERC721, ERC721URIStorage, KeeperCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    ...
    constructor(uint _interval) ERC721("Flower Bootcamp Chainlink ", "FLO") {
        interval = _interval;
        lastTimeStamp = block.timestamp;
    }

    //Aqui defino as regras de atualizacao do NFT
    function checkUpkeep(bytes calldata /* checkData */) external view override returns (bool upkeepNeeded, bytes memory /* performData */) {
        uint256 tokenId = tokenIdCounter.current() - 1; //atualiza o último token criado
        bool done;
